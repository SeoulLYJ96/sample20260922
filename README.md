...
The 'dbx_bundle_20260922' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/dbx_bundle_20260922/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbx_bundle_20260922_etl` to your workspace.
